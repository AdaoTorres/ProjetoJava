...
public class ProjetoJavaGrupo {
	...
	public static void main(String[] args) {
		...
		System.out.println("\n--------------------------------|");
		System.out.println("Vamos conhecer seu potencial ???");
		System.out.println("\nColoque seu primeiro nome: ");nome = sc.next();
		System.out.println("\nColoque seu segundo nome: ");sobreNome = sc.next(); 
		...
		System.out.println("\n------OBRIGADO POR CONFIRMAR SEUS DADOS !!!------");
		System.out.println("--------------------------------------------------");
		...
		System.out.println("\nAGORA VAMOS TESTAR O SEU MINDSET");
		System.out.println("=======================================");
